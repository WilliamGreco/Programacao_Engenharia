...
public class Exe_07 {
    ...
    public static void main(String[] args) {
        ...
        if (num1 < num2 && num1 < num3) {
            System.out.println("O primeiro numero  " + num1 + " é o menor.");

        } else if (num2 < num1 && num2 < num3) {
            System.out.println("O segundo numero " + num2 + " é o menor.");
        } else if (num3 < num1 && num3 < num2) {
            System.out.println("O terceiro numero " + num3 + " é o menor.");
        }
